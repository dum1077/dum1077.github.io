...
// 2. IntersectionObserver 를 사용해서 모든 섹션들을 관찰해야한다.
...
function selectNavItems(index) {
  const navItem = navItems[index]; // 새롭게 선택될 item
  if (!navItem) return; // 안전을 위해 빨리 종료 (잘못된 배열크기 입력시)
